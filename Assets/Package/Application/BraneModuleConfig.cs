...
namespace CyberHub.Brane
{
    ...
    /// </summary>
    public abstract class BraneModuleConfig : ScriptableObject
    {
        ...
        internal void RegisterServices(BraneApp instance)
        {
    ...
    #if UNITY_EDITOR
    [UnityEditor.CustomEditor(typeof(BraneModuleConfig), true)]
